...
namespace ApexCitadels.PC
{
    ...
    public class PCTerritoryBridge : MonoBehaviour
    {
        ...
        public async Task<bool> UpgradeTerritory(string territoryId)
        {
            ...
            {
                ApexLogger.LogWarning(ApexLogger.LogCategory.Territory, "Upgrade not available on this platform");
                return false;
            }
        ...
        public async Task<bool> SaveBlueprint(string territoryId, string name, string description)
        {
            ...
            {
                ApexLogger.LogWarning(ApexLogger.LogCategory.Territory, "Blueprint designer not available on this platform");
                return false;
            }
            ...
            ApexLogger.Log(ApexLogger.LogCategory.Territory, $"Saved blueprint: {name} with {blueprint.Buildings.Count} buildings");
            return true;
        }
        ...
        private void HandleTerritoryAttacked(Territory.Territory territory)
        {
            ...
            PC.UI.PCUIManager.Instance?.ShowNotification(
                ...
                PC.UI.UINotificationType.Combat
            );
        }
